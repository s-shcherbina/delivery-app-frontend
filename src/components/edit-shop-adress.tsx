...
const EditShopAddress: FC = (): JSX.Element => {
  ...
  const handleSubmitShopAddress = async (e: { preventDefault: () => void }) => {
    e.preventDefault();
    // if (add) {
  ...
  return (
    <form onSubmit={handleSubmitShopAddress}>
      <Stack
        spacing={1}
        sx={{
...
export default EditShopAddress;
